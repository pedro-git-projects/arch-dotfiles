...
run "xrandr --auto --output DP-2-1 --mode 1920x1080 --rate 60  --left-of eDP-1"
#run "xrandr --auto --output DP2-1 --mode 1920x1080 --rate 60  --right-of eDP1"
run "nm-applet"
run "cbatticon"
...
run "feh --bg-fill /home/pedro/Pictures/wallpapers/death.jpg --bg-fill /home/pedro/Pictures/wallpapers/sad_jesus_bigger.png"
# run setxkbmap us
#run "spotify-tray"
